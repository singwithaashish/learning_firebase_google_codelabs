            ...
            builder: (context, appState, _) => Column(
              ...
              children: [
                if (appState.loginState == ApplicationLoginState.loggedIn) ...[
                  //remember kids, this is how you add multiple element under alkfalkfn
                  Header('Discussion'),
                  GuestBook(
    ...
    FirebaseAuth.instance.userChanges().listen((user) {
      if (user != null) {
        ...
        _guestBookSubscription =
            FirebaseFirestore.instance //listen to changes and display
        ...
        _guestBookMessages = [];
        _guestBookSubscription?.cancel(); //empty the message and unsubscribe
